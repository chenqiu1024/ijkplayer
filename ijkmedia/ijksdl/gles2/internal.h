...
typedef struct IJK_GLES2_Renderer
{
    ...
    GLubyte* (*func_getLuminanceDataPointer)(GLsizei* outWidth, GLsizei* outHeight, GLsizei* outLength, bool* outIsCopied, SDL_VoutOverlay* overlay);
    ...
    int     gravity;
    int orientation;
    GLsizei layer_width; // View size
    GLsizei layer_height;
    int     frame_width;// Video size
    int     frame_height;
    int     frame_sar_num;
    int     frame_sar_den;
