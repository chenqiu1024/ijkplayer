...
- (void)setupAudioSession
{
    ...
    NSError *error = nil;
     if (NO == [[AVAudioSession sharedInstance] setCategory:AVAudioSessionCategoryPlayAndRecord withOptions:/*AVAudioSessionCategoryOptionDefaultToSpeaker|*/AVAudioSessionCategoryOptionAllowBluetooth error:&error]) {
