...
- (void)play
{
    ...
    self.spec.callback(self.spec.userdata, NULL, 0, 0.0, 0.0, self.spec.audioParams);
...
static void IJKSDLAudioQueueOuptutCallback(void * inUserData, AudioQueueRef inAQ, AudioQueueBufferRef inBuffer) {
    @autoreleasepool {
        ...
        if (!aqController) {
            ...
            (*aqController.spec.callback)(aqController.spec.userdata, inBuffer->mAudioData, inBuffer->mAudioDataByteSize, 0.0, 0.0, aqController.spec.audioParams);
        }
